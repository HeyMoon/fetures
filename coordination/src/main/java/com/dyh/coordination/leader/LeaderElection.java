 ...
 * under the License.
 */
package com.dyh.coordination.leader;
...
public class LeaderElection extends LeaderSelectorListenerAdapter implements Closeable {
    ...
    public LeaderElection(CuratorFramework client, String path, String name) {
        ...
        // LeaderElection here is also a LeaderSelectorListener but this isn't required
        leaderSelector = new org.apache.curator.framework.recipes.leader.LeaderSelector(client, path, this);
    ...
    /**
     * after take leadership,you can do some actions
     * @param client
     * @throws Exception
     */
    @Override
